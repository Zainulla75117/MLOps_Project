    ...
    return pd.DataFrame(
        {
            ...
            "Traffic Volume": [30000, 35000, 28000, 42000, 38000, 25000, 32000, 29000, 40000, 36000],
            "Average Speed": [40.5, 35.2, 45.1, 30.8, 33.5, 42.0, 38.0, 44.0, 31.0, 35.0],
            ...
            "Pedestrian and Cyclist Count": [100, 95, 110, 85, 90, 105, 98, 112, 88, 93],
        }
    )
...
class TestExtractTimeFeatures:
    def test_creates_time_columns(self, sample_df):
        ...
        expected_cols = ["year", "month", "day_of_week", "day_of_month", "is_weekend", "quarter", "week_of_year"]
